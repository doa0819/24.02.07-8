package com.ohgiraffers.test.section1.conditional;
...
public class C_ifElself {
    ...
    public void testSimpleIfElseIfStatement(){
        ...
        /* 수업목표. if-else-if문 단독 사용에 대해 흐름을 이해하고 적용할 수 있다. */
        /* 필기.
         * {if - else - if 문 표현식}
         * if(조건식) {
         *         조건식1 이 true 일 때 실행할 명령문;
         * } else if{
         *     조건식1 이 false 이고, 조건식2가 true 일 때 실핼 할 명령문;
         * }  else {
        ...
        *  코드를 실행한다.
        *  조건식1 과 조건식2의 결과 값이 모두 거짓(false) 이면 else {} 안에 있는 코드 실행.
        * */
        ...
        System.out.println("어느 도끼가 너의 도끼이느냐? (1. 금도끼, 2. 은도끼, 3. 쇠도끼) :");
        ...
        if (answer == 1){
            ...
            System.out.println("욕심이 과하지는 않지만 그래도 넌 거짓말을 해버렸으... 썩 꺼지거라");
        } else {
