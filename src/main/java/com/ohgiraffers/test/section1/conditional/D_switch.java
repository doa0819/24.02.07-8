...
public class D_switch {
    ...
    public void testSimpleSwithchStatement(){
        ...
        *    case 비교값2 : 비교값2 와 일치하는 경우 실핼할 구문; break;
        ...
        *  if - else - if 와 유사하다.
        * 따라서 일부 호환이 가능하다.
        * 하지만, switch 문으로 비교가능한 값은 정수, 문자, 문자열의 형태이다.
        * 실수와 논리는 비교할 수 없다.
    ...
    public void testSwitchVendingMachine(){
        ...
        /*필기. switch 문을 이용해서 문자열 값 비교 및 break 에 대해 테스트 */
